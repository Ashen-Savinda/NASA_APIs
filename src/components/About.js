...
export default function About() {
  ...
  return (
    <div className={`bg-${theme === 'dark' ? 'gray-400' : 'gray-700'} text-${theme === 'dark' ? 'gray-800' : 'gray-200'} p-4 w-screen h-screen`}>
      ...
      <ul className={`list-disc pl-4 mb-4 text-${theme === 'dark' ? 'gray-800' : 'gray-200'}`}>
